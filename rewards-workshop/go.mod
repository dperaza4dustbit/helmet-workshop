module github.com/redhat-appstudio/helmet-workshop/rewards-workshop

go 1.26.7

replace github.com/redhat-appstudio/helmet => ../../helmet
...
require (
	...
	github.com/quay/claircore v1.6.0 // indirect
